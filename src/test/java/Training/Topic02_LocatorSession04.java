...
public class Topic02_LocatorSession04 {
    ...
    public void HW04_CreateNewCustomer() throws InterruptedException, ParseException {
        ...
        By Username1 = (By.xpath("//input[@type = 'text']"));
        ...
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[contains(text(),'New Customer')]")));
        NewCustormer.click();
        Thread.sleep(5000);
        ...
        WebElement getID = driver.findElement((By.xpath("//td[contains(text(),'Customer ID')]//following-sibling::td")));
        String idInput = getID.getText();

        WebElement clickBtnEdit = driver.findElement(By.xpath("//a[contains(text(),'Edit Customer')]"));
        clickBtnEdit.click();
        Thread.sleep(5000);
        WebElement inputID = driver.findElement(By.xpath("//input[@name ='cusid']"));
        inputID.sendKeys(idInput);
        WebElement clickBtnSubmit = driver.findElement(By.xpath("//input[@name ='AccSubmit']"));
        ...
        WebElement Clear = driver.findElement(By.xpath("//input[@name ='name']"));
        Clear.clear();
        customerNameInput.sendKeys("Nguyen Thi Mai Dung");

        WebElement getCustomer = driver.findElement(By.xpath("//input[@name ='name']"));
        String valueName = getCustomer.getAttribute("value");

        Assert.assertEquals(valueName, "Nguyen Thi Mai Dung");
